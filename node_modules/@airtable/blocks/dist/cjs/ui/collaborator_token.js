...
var CollaboratorToken = props => {
  var collaborator = props.collaborator,
      ...
      style = props.style,
      styleProps = (0, _objectWithoutProperties2.default)(props, ["collaborator", "onMouseEnter", "onMouseLeave", "onClick", "hasOnClick", "className", "style"]); // Re-render when collaborator info updates. This is to ensure isActive is accurate.
